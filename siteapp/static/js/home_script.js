...
var close_menu_phase6 = function(extend_func, extend_func_shadow) {
	...
	extend_func.setAttribute('x', '7.5%');
	extend_func.setAttribute('y', '11%');
	extend_func_shadow.setAttribute('x', '7.5%');
	extend_func_shadow.setAttribute('y', '11%');
	...
	extend_func.style.fontSize = reduce_fontSize +'vmax';
	extend_func_shadow.style.fontSize = reduce_fontSize +'vmax';
